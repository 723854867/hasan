...
import org.hasan.bean.model.OrderListInfo;
...
public class OrderService {
	...
	public Pager<OrderListInfo> orders(Query query) {
		...
		list.forEach(item -> {
			...
			orderListInfos.add(new OrderListInfo(item, infos, orderGoods));
		});
		return new Pager<OrderListInfo>(orderListInfos);
	}
